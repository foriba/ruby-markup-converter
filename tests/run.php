...
try {
	...
	foreach ( array( 'unit/autoload.php', 'integration/bootstrap.php', 'unit/values.php', 'integration/conversion.php', 'integration/settings.php', 'integration/post-content-filter.php', 'integration/blocks.php', 'integration/shortcode.php', 'integration/frontend-assets.php' ) as $file ) {

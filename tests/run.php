...
try {
	...
	foreach ( array( 'unit/autoload.php', 'integration/bootstrap.php', 'unit/values.php', 'integration/conversion.php', 'integration/settings.php', 'integration/post-content-filter.php' ) as $file ) {

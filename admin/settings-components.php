 ...
 *
 * @param array<int, array{ id:string, value:string, label:string, description:string, is_selected:bool }> $choices    選択肢一覧.
 ...
 *
 * @param array{ id:string, value:string, label:string, description:string, is_selected:bool } $choice      選択肢データ.
 * @param string                                                                               $option_name option 名.
 */

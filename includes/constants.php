 ...
 * @var string[]
 */
const RUBYMACO_ALLOWED_RULE_TYPES = [
...
{
    return [
        RUBYMACO_BOUTEN_STYLE_DOT => [
            'label' => __('dot', 'ruby-markup-converter'), // ja-jp: '点'
        ],
        RUBYMACO_BOUTEN_STYLE_SESAME => [
...
{
    return [
        RUBYMACO_BOUTEN_RENDERER_CUSTOM => [
        ...
        RUBYMACO_BOUTEN_RENDERER_TEXT_EMPHASIS => [
